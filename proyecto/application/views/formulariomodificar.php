    ...
    <div class="col-md-12">
      ...
      foreach ($infocliente->result() as $row) 
      {
        ...
        ?> 
              ...
              <div id="emailHelp" class="form-text">Primer apellido</div>
              ...
              <div id="emailHelp" class="form-text">Segundo apellido</div>
              ...
              <div id="emailHelp" class="form-text">Numero de telefono</div>
